...
::: {.related-box}
**Related section**  
The dimensions of fairness are described in **Section 3 of the main paper.**
:::
:::
...
::: {.related-box}
**Related section**  
The measurements associated with the dimensions of fairness are described in **Section 4.3 of the main paper.**
:::
:::
...
## Measuring proxy disparities

To assess proxy disparity, we take inspiration from @Lindholm/al:2024 by measuring individual "proxy effects". Following @SelectionBias_2024, we measure proxy effects as the difference between a given premium and the aware premium. We then compare their distributions across protected groups. This aligns with the *proxy parity* criterion of @SelectionBias_2024. Implicitly, we assume that our estimate of the aware premium is unbiased, otherwise proxy effect assessment may be highly unreliable. 
...
```{r}
#| code-fold: true
#| code-summary: Code that generates the measurement table for scenario 1
#| warning: false
#| message: false
library(knitr)
library(kableExtra)
...
```{r}
#| code-fold: true
#| code-summary: Code that generates the measurement table for scenario 2
#| warning: false
#| message: false
...
```{r}
#| code-fold: true
#| code-summary: Code that generates the measurement table for scenario 3
#| warning: false
#| message: false
...
## Visualization of alignment with dimensions
...
for (the_scen in names(the_alignement_table)) {
  the_local_table <- the_alignement_table[[the_scen]]
...
#| code-fold: true
#| code-summary: Code that generates the alignment table for scenario 1
#| warning: false
#| message: false
...
#| code-fold: true
#| code-summary: Code that generates the alignment table for scenario 2
#| warning: false
#| message: false
...
#| code-fold: true
#| code-summary: Code that generates the alignment table for scenario 3
#| warning: false
#| message: false
